...
const frameProps = {
  ...
  yExtent: [0],
  xExtent: [0],
  pointStyle: (d: { title: string }) => {
    return {
      r: 5,
      fill: d.title === 'Ex Machina' ? '#ac58e5' : d.title === 'Far from the Madding Crowd' ? '#E0488B' : '#9fd0cb',
    };
  },
  title: (
    <text textAnchor="middle">
      Theaters showing <tspan fill={'#ac58e5'}>Ex Machina</tspan> vs <tspan fill={'#E0488B'}>Far from the Madding Crowd</tspan>
    </text>
  ),
  axes: [
